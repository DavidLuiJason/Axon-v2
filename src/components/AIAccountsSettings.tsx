                      ...
                      {isEditing ? (
                        <div className="flex items-center gap-2">
                          <input
                            ...
                            className="flex-1 px-2.5 py-1.5 rounded-lg bg-neutral-950 border border-neutral-700 text-white text-xs font-mono focus:border-white focus:outline-none"
                            autoFocus
                          />
                          <button
                            type="button"
          ...
          <div className="space-y-3 text-xs">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 rounded-xl bg-neutral-950 border border-neutral-800 text-white font-mono focus:outline-none"
              />
            </div>
